...
const { generateDepartmentID, insertDepartment, } = useDepartment();
...
onMounted(async () => {
  try {
    ...
    department.value.department_id = id
  } catch (e) {
    console.log(e)
  }
})
...
async function onSubmit() {
  ...
  try {
    ...
    await insertDepartment(department.value);
        ...
        <v-col cols="12" md="12">
          <v-row>
            <v-col cols="12" sm="6" lg="4">
              <v-label class="mb-2">ชื่อแผนก<span class="text-error ml-1">*</span></v-label>
